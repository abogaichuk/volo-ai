...
use crate::{movement::{MovementProfile, walker::Walker}, rooms::shelter::Shelter};
...
impl RemoteUpgrader {
    pub fn new(home: Option<RoomName>, workplace: Option<Position>, ctrl: ObjectId<StructureController>, boost: bool) -> Self {
