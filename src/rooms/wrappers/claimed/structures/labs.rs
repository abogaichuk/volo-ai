...
use crate::{
    commons::find_container_with, rooms::{
        RoomEvent, shelter::Shelter, state::{
...
impl Claimed {
    ...
    //                                 data.resource.reaction_components().iter()
    //                                     .find_map(|components| components.iter()
    //                                         .find_map(|component| {
    //                                             //if not enough components -> create Lack event!
