use log::info;
use screeps::{HasPosition, Position, RoomXY, pathfinder::SearchGoal};
use itertools::Itertools;
use std::collections::HashMap;
use crate::{
    movement::{callback::construction_single_room, find_many_in_room},
    rooms::state::constructions::{
        LinkType, PlannedCell, RoomPart, RoomPlan, RoomPlannerError, RoomStructure, owned::{place_for_container, walkable_neighbors, walkable_range}
    }
};
...
mod tests {
    ...
    //     let cells = plan(&cross_road, &sources, &grid).expect("expect ctrl planned cells");
